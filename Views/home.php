        ...
        <div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    <li class="nav-item"><a href="home.php" class="nav-link"><img src="./img/logo-twitterblue.svg" alt="" class="icon" style="width: 70%;"></a></li>
                    ...
                    <li class="nav-item"><a href="post.php" class="nav-link"><img src="./img/icon-post-tweet-twitterblue.svg" alt="" class="post-tweet" style="width: 80%;"></a></li>
